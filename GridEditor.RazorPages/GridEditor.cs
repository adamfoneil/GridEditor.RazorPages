...
namespace GridEditor.RazorPages
{
    public class GridEditor<TRecord> where TRecord : class, new()
    {
        ...
        private TRecord _record = default;
        private int _id = 0;
        ...
        private readonly Func<TRecord, int> _idAccessor = null;
        ...
        public GridEditor(PageBase pageBase, IAntiforgery antiForgery, Func<TRecord, int> idAccessor, string namePrefix = null, object defaults = null)
        {
            _pageBase = pageBase;
